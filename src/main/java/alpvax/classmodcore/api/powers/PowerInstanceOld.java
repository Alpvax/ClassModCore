...
public class PowerInstanceOld
{
	...
	protected PowerInstanceOld(IPower power, EnumPowerCastType targetType, boolean isAutomatic, Map<String, Object> additionalData)
	{
		this.power = power;
