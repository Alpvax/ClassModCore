...
{
	/*public static final String modID = "classmodcore";
	public static final String modName = "Player Class Mod";
	public static final String modVersion ="0.1.164";*/
	...
	//private static final String[] disallowed = new String[]{NULL_CHAR, CLASS_SPLIT, /*CLASS_PWR_SPLIT, */PWR_SPLIT, PWR_SUBSPLIT};
	...
	public static void throwClassNameError(String name)
	{
		...
		{
		case 0: return;
		case 1: throw new IllegalArgumentException("The name of the class must be unique (case insensitive) and not null or an empty string.");
		case 2: throw new IllegalArgumentException("The name of the class cannot contain spaces.");
		case 3: throw new IllegalArgumentException("The name of the class cannot contain any of these strings: " + getDisallowed());
		}
	}
	public static String getDisallowed()
	{
		...
		/*s.append(NULL_CHAR).append("\", \"");
		s.append(CLASS_SPLIT).append("\", \"");
		//s.append(CLASS_PWR_SPLIT).append("\", \"");
		s.append(PWR_SPLIT).append("\", \"");
		s.append(PWR_SUBSPLIT);*/
		return s.toString();
	}
	...
	public static void init(File configDir)
	{
		...
		//nightvisionAttID = UUID.fromString(config.get("UUIDs", "ID for nightvision Attribute", UUID.randomUUID().toString()).getString());
		config.save();
